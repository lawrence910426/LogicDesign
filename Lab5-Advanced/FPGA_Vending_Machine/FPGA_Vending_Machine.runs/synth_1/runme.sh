...
HD_PWD='D:/LogicDesignExperiment/share_repo/Lab5-Advanced/FPGA_Vending_Machine/FPGA_Vending_Machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_VendingMachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_VendingMachine.tcl

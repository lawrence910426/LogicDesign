...
HD_PWD='D:/LogicDesignExperiment/share_repo/Lab5-Advanced/FPGA_1/FPGA_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_Team3_Music_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab5_Team3_Music_fpga.tcl -notrace

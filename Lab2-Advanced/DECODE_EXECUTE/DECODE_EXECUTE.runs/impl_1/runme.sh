...
HD_PWD='D:/LogicDesignExperiment/share_repo/Lab2-Advanced/DECODE_EXECUTE/DECODE_EXECUTE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Decode_And_Execute_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Decode_And_Execute_tb.tcl -notrace

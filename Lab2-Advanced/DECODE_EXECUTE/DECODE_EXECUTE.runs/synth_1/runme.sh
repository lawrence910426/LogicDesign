...
HD_PWD='D:/LogicDesignExperiment/share_repo/Lab2-Advanced/DECODE_EXECUTE/DECODE_EXECUTE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decode_And_Execute_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decode_And_Execute_tb.tcl

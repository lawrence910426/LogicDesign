...
HD_PWD='C:/home/Lab2_Basic/Lab2_Basic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adders_t.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adders_t.tcl

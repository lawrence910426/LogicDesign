...
HD_PWD='D:/LogicDesignExperiment/final_project/STATE_CHANGE/STATE_CHANGE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log STATE_CHANGE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source STATE_CHANGE.tcl -notrace

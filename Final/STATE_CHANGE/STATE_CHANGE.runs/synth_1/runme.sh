...
HD_PWD='D:/LogicDesignExperiment/final_project/STATE_CHANGE/STATE_CHANGE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log STATE_CHANGE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source STATE_CHANGE.tcl

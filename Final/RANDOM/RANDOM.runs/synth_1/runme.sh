...
HD_PWD='D:/LogicDesignExperiment/final_project/RANDOM/RANDOM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RANDOM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RANDOM.tcl

...
HD_PWD='D:/LogicDesignExperiment/final_project/RANDOM/RANDOM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RANDOM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RANDOM.tcl -notrace

...
HD_PWD='C:/home/github/LogicDesign/Final/TopMaster/TopMaster.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopMaster.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopMaster.tcl -notrace

...
HD_PWD='C:/home/github/LogicDesign/Final/TopMaster/TopMaster.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopMaster.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopMaster.tcl

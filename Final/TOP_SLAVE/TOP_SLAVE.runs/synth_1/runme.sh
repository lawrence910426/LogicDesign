...
HD_PWD='D:/LogicDesignExperiment/final_project/TOP_SLAVE/TOP_SLAVE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_SLAVE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_SLAVE.tcl

...
HD_PWD='D:/LogicDesignExperiment/final_project/TOP_SLAVE/TOP_SLAVE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_SLAVE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_SLAVE.tcl -notrace

...
#
# Generated by export_simulation on Thu Jan 13 10:56:39 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_conv_1_weight.sh' script.

./blk_mem_gen_conv_1_weight.sh -reset_run
...
./blk_mem_gen_conv_1_weight.sh -noclean_files

For more information on the script, please type './blk_mem_gen_conv_1_weight.sh -help'.

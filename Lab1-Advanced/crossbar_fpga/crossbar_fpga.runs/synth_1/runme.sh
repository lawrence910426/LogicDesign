...
HD_PWD='D:/LogicDesignExperiment/LAB01_0923/share_repo/Lab1-Advanced/crossbar_fpga/crossbar_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log crossbar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source crossbar.tcl

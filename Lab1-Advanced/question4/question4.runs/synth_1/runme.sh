...
HD_PWD='D:/LogicDesignExperiment/LAB01_0923/share_repo/Lab1-Advanced/question4/question4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T_Flip_Flop_t.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T_Flip_Flop_t.tcl
